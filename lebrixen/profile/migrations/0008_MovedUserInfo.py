...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ClientApp.password'
        db.delete_column('profile_clientapp', 'password')

        # Deleting field 'ClientApp.contact'
        db.delete_column('profile_clientapp', 'contact')

        # Adding field 'ClientApp.user'
        db.add_column('profile_clientapp', 'user', self.gf('django.db.models.fields.related.OneToOneField')(related_name='app', unique=True, null=True, to=orm['auth.User']), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Adding field 'ClientApp.password'
        db.add_column('profile_clientapp', 'password', self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True), keep_default=False)

        # Adding field 'ClientApp.contact'
        db.add_column('profile_clientapp', 'contact', self.gf('django.db.models.fields.EmailField')(default='', max_length=75, blank=True), keep_default=False)

        # Deleting field 'ClientApp.user'
        db.delete_column('profile_clientapp', 'user_id')
