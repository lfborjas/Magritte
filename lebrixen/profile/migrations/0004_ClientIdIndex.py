...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'ClientUser', fields ['clientId']
        db.create_index('profile_clientuser', ['clientId'])
    
    
    def backwards(self, orm):
        
        # Removing index on 'ClientUser', fields ['clientId']
        db.delete_index('profile_clientuser', ['clientId'])
