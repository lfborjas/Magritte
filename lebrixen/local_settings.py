...
import os
from settings import MIDDLEWARE_CLASSES, INSTALLED_APPS, ROOT_PATH
DEBUG = True
#in development, I use a sqlite db:
DATABASE_ENGINE = 'sqlite3'           # 'postgresql_psycopg2', 'postgresql', 'mysql', 'sqlite3' or 'oracle'.
DATABASE_NAME = os.path.join(ROOT_PATH,'lebrixen')             # Or path to database file if using sqlite3.
